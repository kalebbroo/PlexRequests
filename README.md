...
the extension button on the 1337x or ext.to row to download the XPI. Then open
`about:debugging#/runtime/this-firefox`, choose **Load Temporary Add-on**, and select the downloaded XPI.
